--[[
Krypton - Hat Reanimate
Emperyean - Hat Reanimate
Hatless - SDA Reanimate 
------------------------------------------------------
Hatless only works on r15 and games without voice chat
------------------------------------------------------
Krypton does not have flinging as of now but its hella optimized and smooth
------------------------------------------------------
]]

getgenv().Framework = "Hatless" 
loadstring(game:HttpGet("https://gist.githubusercontent.com/MelonsStuff/f61fc110c0dc167e263cec94518390a1/raw/f45ae28bdfd503af662214032432f7487c0ac419/DisbeliefHub.lua"))()

--[[
Credits:
Gelatek - created Krypton
Emper - created Empyrean
PresidentAnvil - Created Hatless
Melon - created Disbelief Hub
...
Socials:
// https://x.com/MelonScripter - inactive
